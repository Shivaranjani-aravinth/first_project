...
<head>
<title>Driver-Registeration</title>
<style>
...
<h2>Driver Registeration</h2></font></div>
    <font color="red">${errorMessage}</font>
    <form:form action="driverregister" method="post" modelAttribute="driver">
        ...
        License NO.: <form:input type="text" path="licenseno" required="true"/> <br>
